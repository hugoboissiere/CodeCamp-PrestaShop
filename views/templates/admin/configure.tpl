	...
	<div class="panel">
		...
		<form method="POST" action="" id="csvform">
			...
			<div class="panel-footer">
				...
				<a class="btn btn-default" id="download" style="text-decoration: none;font-size:12px;font-family:'Open Sans',Helvetica,Arial,sans-serif;padding:4px;padding-left:8px;padding-right:8px;border-radius:3px;border:1px solid #cccccc;box-shadow:#e6e6e6 0 -2px 0 inset" href="../modules/codecamp/e.txt" download="e.txt"><i class="icon icon-arrow-down"></i> TEST DOWNLOAD</a>
			</div>
		</form>
	</div>
...
>>>>>>> 7563fbd86567012be587beff3deacda4cc1b8d82
